  ...
  static override get METADATA() {
    const options: Option[] = [
      ...
      },
      {
        id: 'manifestUrl',
        name: 'Manifest URL',
        description: 'Provide the Manifest URL for this AIOLiveTV or AIOStreams addon.',
        type: 'url',
        required: true,
      },
      {
    ...
    return {
      ID: 'aiostreams',
      NAME: 'AIOLiveTV',
      LOGO: 'https://raw.githubusercontent.com/mrcanelas/aiolivetv/refs/heads/main/packages/frontend/public/logo.png',
      URL: [],
      TIMEOUT: appConfig.presets.defaultTimeout,
      USER_AGENT: appConfig.http.aiostreamsUserAgent,
      SUPPORTED_SERVICES: [],
      DESCRIPTION: 'Wrap another AIOLiveTV or AIOStreams instance.',
      OPTIONS: options,
