---
title: User
description: Create, retrieve, update, and delete AIOLiveTV user configurations.
---

`/api/v1/user`

Manage AIOLiveTV user accounts and configurations. A **user** is identified by a UUID and protected by a password. These endpoints are the programmatic equivalent of the **Save & Install** flow in the UI.
