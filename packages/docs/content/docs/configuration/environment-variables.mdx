...
| `CRON_SECRET`               | —                           | Bearer token required by `/api/internal/tasks/*` if you trigger maintenance tasks yourself. Not needed for a Hobby deploy without scheduled crons.                                                                                                                                                           |
