...
The **Grouping** feature lets you control _when_ different sets of your addons are asked for streams. This is useful for making AIOLiveTV faster by only querying fallback addons when your primary sources don't find enough results.
...
<Steps>
  <Step>
    **Parallel fetch start** — AIOLiveTV begins fetching from **all groups**
    simultaneously.
  </Step>
  <Step>
    **Evaluate as results arrive** — as soon as Group 1 responds, AIOLiveTV
...
**Example:** AIOLiveTV fires off fetches for Groups 1, 2, and 3 concurrently.
