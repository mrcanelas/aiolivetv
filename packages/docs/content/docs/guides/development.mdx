---
title: Development
description: How to set up AIOLiveTV locally for development and contribution.
---
...
Contributions are welcome! Please open an issue or pull request on [GitHub](https://github.com/mrcanelas/aiolivetv). For questions or discussion, join the [GitHub Issues](https://github.com/mrcanelas/aiolivetv/issues).
