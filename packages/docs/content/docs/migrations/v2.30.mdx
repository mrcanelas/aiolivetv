---
title: v2.30 Changes
description: What changed in AIOLiveTV v2.30 and the few actions self-hosters need to take.
---
...
<Callout type="info">
  You can find a list of all service IDs [here](https://github.com/mrcanelas/aiolivetv/blob/2f42d4723e036b941154819552165379fd4ce3dc/packages/core/src/utils/constants.ts#L228-L243)
  and a list of credential IDs [here](https://github.com/mrcanelas/aiolivetv/blob/2f42d4723e036b941154819552165379fd4ce3dc/packages/core/src/utils/constants.ts#L329-L779).
</Callout>
...
<Accordions>
  <Accordion title="How to migrate settings from environment variables to the dashboard">
    <Steps>
      ...
      <Step>
        Restart/recreate AIOLiveTV with your updated environment configuration.
