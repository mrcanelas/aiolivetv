...
AIOLiveTV is based on AIOStreams v2. Use this guide if you are migrating an **AIOStreams v1** installation.
...
If you run into issues not covered here, join the [GitHub Issues](https://github.com/mrcanelas/aiolivetv/issues) for help.
